...
void main() {
  group('BestMatch', () {
    test('toString return "index:rating"', () {
      final bestRating = Rating(rating: 1.23456, target: 'str', index: 0);
      final bestMatch = BestMatch(
        bestMatchIndex: 1,
        bestMatch: bestRating,
        ratings: <Rating>[
          Rating(rating: 0.01, target: 'str', index: 0), bestRating
        ]);
    ...
    test('toString with null target return "index:rating"', () {
      final bestRating = Rating(rating: 1.23456, target: null, index: 0);
      final bestMatch = BestMatch(
        bestMatchIndex: 1,
        bestMatch: bestRating,
        ratings: <Rating>[
